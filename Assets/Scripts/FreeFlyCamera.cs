...
// Adapted for recording and extra controls by Michael Siebenmann
...
public class FreeFlyCamera : MonoBehaviour
{
    ...
    long count = 0;
    [SerializeField]
    [Tooltip("Capture a screenshot every frame and store in Assets.dataPath/Screenshots")]
    ...
    [SerializeField]
    [Tooltip("Toggle rotation enabled")]
    private KeyCode _toggleRotationEnabled = KeyCode.F;
    ...
    private void Update()
    {
        ...
        if (Input.GetKeyDown(_toggleRotationEnabled))
        ...
        if (_enableRotation)
        {
            ...
            transform.rotation = Quaternion.Euler(
                ...
                transform.eulerAngles.y + Input.GetAxis("Mouse X") * _mouseSensitivity,
        ...
        if (capture)
        {
            ScreenCapture.CaptureScreenshot(Application.dataPath + "/Screenshots/" + (count++) + ".png", 2);
        }
    }
}
